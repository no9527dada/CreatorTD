...
public class CreatorTowerDefenseInfoDialog2 {
    ...
    public static void show() {
        ...
        hghghg = new BaseDialog("warning") {
...

            {
                ...
                cont.pane((i -> {
                    i.add(Core.bundle.format("ct3tdZHUYI2")).left().growX().wrap().width(620).maxWidth(620).pad(4).labelAlign(Align.left).row();
