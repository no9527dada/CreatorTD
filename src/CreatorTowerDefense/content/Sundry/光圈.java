...
//本代码由 @guiY 提供
public class 光圈 {
    public static Block 光圈1,光圈2,光圈3,光圈4,光圈5;
...
//    requirements(Category.turret, with(魂, 25,魄,800,星辰,300));
        ...
        光圈3=new CreatorTowerDefenseType.TDPowerTurret("光圈3",40,22) {{
            ...
            rotateSpeed = 0;
            shootCone = 360;//射击瞄准角度
            consumePower(1300f/60);
           // requirements(Category.turret, with(魂, 25));
            requirements(Category.turret, with(魂, 7300,魄,2800,星辰,15));
            float cont = 360 / 2f;//扩散角度，1/2值，60 = 120
            float bRange = range;//范围
            shootType = new BulletType() {
                {
        ...
        光圈4=new CreatorTowerDefenseType.TDPowerTurret("光圈4",30,28) {{
            Color TU浅绿色 = Color.valueOf("acff9a");
            range = 28 * 8;
            size = 3;
            升级前置 = 光圈3;
            ...
            rotateSpeed = 0;
            shootCone = 360;//射击瞄准角度
            consumePower(1900f/60);
            // requirements(Category.turret, with(魂, 25));
            requirements(Category.turret, with(魂, 16000,魄,9000,星辰,30));
            float cont = 360 / 2f;//扩散角度，1/2值，60 = 120
            float bRange = range;//范围
            shootType = new BulletType() {
                {
        ...
        光圈5=new CreatorTowerDefenseType.TDPowerTurret("光圈5",15,38) {{
            Color TU浅绿色 = Color.valueOf("acff9a");
            range = 38 * 8;
            size = 4;
            升级前置 = 光圈3;
            ...
            rotateSpeed = 0;
            shootCone = 360;//射击瞄准角度
            consumePower(6500f/60);
            // requirements(Category.turret, with(魂, 25));
            requirements(Category.turret, with(魂, 42000,魄,32000,星辰,150,无尽星辰,1));
            float cont = 360 / 2f;//扩散角度，1/2值，60 = 120
            float bRange = range;//范围
            shootType = new BulletType() {
                {
