...
public class CreatorTowerDefenseUnits2{
    public static void load(){
        //region ground attack
          class CTUnitType extends UnitType{
        ...
        UnitType  尖刀 = new CTUnitType("dagger", "dagger"){{
            controller = u -> new OnlyAttackCoreAI.GroundOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.5f;
            hitSize = 8f;
            health = 150;
        ...
        UnitType 战锤 = new CTUnitType("mace","mace"){{
            controller = u -> new OnlyAttackCoreAI.GroundOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.5f;
            hitSize = 10f;
            health = 550;
        ...
        UnitType 堡垒 = new CTUnitType("fortress","fortress"){{
            controller = u -> new OnlyAttackCoreAI.GroundOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.43f;
            hitSize = 13f;
            rotateSpeed = 3f;
        ...
        UnitType  权杖 = new CTUnitType("scepter","scepter"){{
            controller = u -> new OnlyAttackCoreAI.GroundOnlyAttackCoreAI();//单位的AI 塔防AI
        ...
        UnitType 王座 = new CTUnitType("reign","reign"){{
            controller = u -> new OnlyAttackCoreAI.GroundOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.35f;
            hitSize = 26f;
            rotateSpeed = 1.65f;
        ...
        UnitType  星辉 = new CTUnitType("flare","flare"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            mineTier = 2;
            mineSpeed = 2.0f;
            speed = 2.7f;
            accel = 0.08f;
        ...
        UnitType 天垠 = new CTUnitType("horizon","horizon"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            mineTier = 3;
            mineSpeed = 3;
            health = 340;
        ...
        UnitType 亡魂 = new CTUnitType("zenith","zenith"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            mineTier = 4;
            mineSpeed = 3;
            health = 700;
        ...
        UnitType 月影 = new CTUnitType("antumbra","antumbra"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.8f;
            accel = 0.04f;
            drag = 0.04f;
        ...
        UnitType 日蚀 = new CTUnitType("eclipse","eclipse"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            speed = 0.54f;
            accel = 0.04f;
            drag = 0.04f;
        ...
        UnitType  独影 = new CTUnitType("mono","flare"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            flying = true;
            drag = 0.06f;
            accel = 0.12f;
        ...
        UnitType  幻型 = new CTUnitType("poly","flare"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            flying = true;
            drag = 0.05f;
            speed = 2.6f;
        ...
        UnitType 巨像 = new CTUnitType("mega","flare"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            mineTier = 3;
            mineSpeed = 4f;
            health = 540f;
        ...
        UnitType  雷霆 = new CTUnitType("quad","quad"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
            armor = 8f;
            health = 6000;
            speed = 1.2f;
        ...
        UnitType 要塞 = new CTUnitType("oct","oct"){{
            controller = u -> new OnlyAttackCoreAI.FlyingOnlyAttackCoreAI();//单位的AI 塔防AI
           // aiController = DefenderAI::new;
            ...
            ammoCapacity = 1;
            abilities.add(
                    new ForceFieldAbility(140f, 4f, 7000f, 30f * 8),
        ...
        UnitType  海神 = new CTUnitType("omura","omura"){{
            ...
            abilities.add(
                    new UnitSpawnAbility(星辉, spawnTime, 19.25f, -31.75f),
                    new UnitSpawnAbility(星辉, spawnTime, -19.25f, -31.75f));
